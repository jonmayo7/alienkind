...
-- perspectives_copublish not created in included migrations — guard with IF EXISTS
DO $$ BEGIN
  IF EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'perspectives_copublish') THEN
